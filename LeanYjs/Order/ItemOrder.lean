...
inductive OriginReachableStep {A} : YjsPtr A -> YjsPtr A -> Prop where
  | reachable : forall o r id c, OriginReachableStep (YjsItem.mk o r id c) o
  | reachable_right : forall o r id c, OriginReachableStep (YjsItem.mk o r id c) r
...
theorem ConflictLt'.ltOriginDiff {A : Type} (l1 l2 r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) :
  YjsLt' l2 l1
  -> YjsLt' (YjsItem.mk l1 r1 id1 c1) r2
  -> YjsLt' l1 (YjsItem.mk l2 r2 id2 c2)
  -> YjsLt' (YjsItem.mk l2 r2 id2 c2) r1
  -> ConflictLt' (A := A) (YjsItem.mk l1 r1 id1 c1) (YjsItem.mk l2 r2 id2 c2) := by
...
theorem ConflictLt'.ltOriginSame {A : Type} (l r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) :
  YjsLt' (YjsItem.mk l r1 id1 c1) r2
  -> YjsLt' (YjsItem.mk l r2 id2 c2) r1
  -> id1 < id2
  -> ConflictLt' (A := A) (YjsItem.mk l r1 id1 c1) (YjsItem.mk l r2 id2 c2) := by
...
theorem YjsLt'.ltOrigin {A : Type} (x o r : YjsPtr A) id c : YjsLeq' x o -> YjsLt' x (YjsItem.mk o r id c) := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
  apply YjsLt.ltOrigin <;> try assumption

theorem YjsLt'.ltRightOrigin {A : Type} (o r : YjsPtr A) id c x : YjsLeq' r x -> YjsLt' (YjsItem.mk o r id c) x := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
...
theorem yjs_lt_cases A h (x y : YjsPtr A) :
  ...
  | ltRightOrigin h o r id c x hlt =>
