...
inductive OriginReachableStep {A} : YjsPtr A -> YjsPtr A -> Prop where
  | reachable : forall o r id c d, OriginReachableStep (YjsItem.item o r id c d) o
  | reachable_right : forall o r id c d, OriginReachableStep (YjsItem.item o r id c d) r
...
mutual
  inductive YjsLt {A : Type} : Nat -> YjsPtr A -> YjsPtr A -> Prop where
    ...
    | ltOrigin h x o r id c d : YjsLeq h x o -> YjsLt (h + 1) x (YjsItem.item o r id c d)
    | ltRightOrigin h o r id c d x : YjsLeq h r x -> YjsLt (h + 1) (YjsItem.item o r id c d) x
  ...
  inductive ConflictLt {A : Type} : Nat -> YjsPtr A -> YjsPtr A -> Prop where
    | ltOriginDiff h1 h2 h3 h4 l1 l2 r1 r2 id1 id2 c1 c2 d1 d2 :
      YjsLt h1 l2 l1
      -> YjsLt h2 (YjsItem.item l1 r1 id1 c1 d1) r2
      -> YjsLt h3 l1 (YjsItem.item l2 r2 id2 c2 d2)
      -> YjsLt h4 (YjsItem.item l2 r2 id2 c2 d2) r1
      -> ConflictLt (max4 h1 h2 h3 h4 + 1) (YjsItem.item l1 r1 id1 c1 d1) (YjsItem.item l2 r2 id2 c2 d2)
    | ltOriginSame h1 h2 l r1 r2 id1 id2 (c1 c2 : A) (d1 d2 : Bool) :
      YjsLt h1 (YjsItem.item l r1 id1 c1 d1) r2
      -> YjsLt h2 (YjsItem.item l r2 id2 c2 d2) r1
      -> id1 < id2
      -> ConflictLt (max h1 h2 + 1) (YjsItem.item l r1 id1 c1 d1) (YjsItem.item l r2 id2 c2 d2)
end
...
theorem ConflictLt'.ltOriginDiff {A : Type} (l1 l2 r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) :
  YjsLt' l2 l1
  -> YjsLt' (YjsItem.item l1 r1 id1 c1 d1) r2
  -> YjsLt' l1 (YjsItem.item l2 r2 id2 c2 d2)
  -> YjsLt' (YjsItem.item l2 r2 id2 c2 d2) r1
  -> ConflictLt' (A := A) (YjsItem.item l1 r1 id1 c1 d1) (YjsItem.item l2 r2 id2 c2 d2) := by
...
theorem ConflictLt'.ltOriginSame {A : Type} (l r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) (d1 d2 : Bool) :
  YjsLt' (YjsItem.item l r1 id1 c1 d1) r2
  -> YjsLt' (YjsItem.item l r2 id2 c2 d2) r1
  -> id1 < id2
  -> ConflictLt' (A := A) (YjsItem.item l r1 id1 c1 d1) (YjsItem.item l r2 id2 c2 d2) := by
...
theorem YjsLt'.ltOrigin {A : Type} (x o r : YjsPtr A) id c d : YjsLeq' x o -> YjsLt' x (YjsItem.item o r id c d) := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
  apply YjsLt.ltOrigin <;> try assumption

theorem YjsLt'.ltRightOrigin {A : Type} (o r : YjsPtr A) id c d x : YjsLeq' r x -> YjsLt' (YjsItem.item o r id c d) x := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
