...
theorem yjs_lt_conflict_lt_decreases {A} {P : ItemSet A} :
  ...
  cases hltxy with
  | ltOriginDiff h1 h2 h3 h4 o1 o2 r1 r2 id1 id2 c1 c2 hlt1 hlt2 hlt3 hlt4 =>
    cases hltyx with
    | ltOriginDiff h1' h2' h3' h4' _ _ _ _ _ _ _ _ hlt1' hlt2' hlt3' hlt4' =>
      exists o1, o2
      constructor
    ...
    | ltOriginSame h1' h2' _ _ o r id c =>
      exists o1, o1
      constructor
      . apply hP.closedLeft at hpx; assumption
      constructor
      ...
      . simp [YjsPtr.size, YjsItem.size]; omega
      constructor <;> (constructor; assumption)
  | ltOriginSame h1 h2 o r1 r2 id1 id2 c1 c2 hlt1 hlt2 hidlt =>
    cases hltyx with
    | ltOriginDiff h5 h6 h7 h8 o1 o2 r1' r2' id1' id2' c1' c2' hlt1' hlt2' hlt3' hlt4' =>
      exists o, o
      constructor;
      . apply hP.closedLeft at hpx; assumption
      constructor;
      ...
      . simp [YjsPtr.size, YjsItem.size]; omega
      constructor <;> (constructor; assumption)
    | ltOriginSame h5 h6 _ _ o r id c =>
      unfold ClientId at *
...
theorem yjs_leq_right_origin_decreases {A} [DecidableEq A] {P : ItemSet A} (inv : ItemSetInvariant P) (x : YjsItem A) (y : YjsPtr A) :
  ...
  have hyxr : YjsLt' y r := by
    apply yjs_lt_trans hP (y := (YjsItem.mk o r id c)) <;> try assumption
