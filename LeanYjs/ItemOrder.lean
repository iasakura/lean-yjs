...
theorem ConflictLt'.ltOriginDiff {A : Type} (l1 l2 r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) :
  ...
  -> ConflictLt' (A := A) (YjsItem.item l1 r1 id1 c1) (YjsItem.item l2 r2 id2 c2) := by
...
theorem ConflictLt'.ltOriginSame {A : Type} (l r1 r2 : YjsPtr A) (id1 id2 : YjsId) (c1 c2 : A) :
  ...
  -> id1 < id2
  -> ConflictLt' (A := A) (YjsItem.item l r1 id1 c1) (YjsItem.item l r2 id2 c2) := by
...
theorem YjsLt'.ltOrigin {A : Type} (x o r : YjsPtr A) id c : YjsLeq' x o -> YjsLt' x (YjsItem.item o r id c) := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
  apply YjsLt.ltOrigin <;> try assumption

theorem YjsLt'.ltRightOrigin {A : Type} (o r : YjsPtr A) id c x : YjsLeq' r x -> YjsLt' (YjsItem.item o r id c) x := by
  intros hleq
  obtain ⟨ h, hleq ⟩ := hleq
  constructor
